...
class TestInit(TestCase):
    ...
    def test_init_gallery(self):
        ...
        with TemporaryGallery(with_gallery_conf=False) as gallery_path:
    ...
    def test_init_album(self):
        ...
        photos.
        """
        with TemporaryGallery(with_album_conf=False) as gallery_path:
            ...
            self.assert_valid_configuration(album_path / 'album.ini', {
                'album': ['title', 'date'],
                'photos': TemporaryGallery.PHOTOS
            })
